...
type UserExtract struct {
	...
	ExtractPrice uint32    `gorm:"column:extract_price;type:decimal(8, 2) UNSIGNED;comment:提现金额;default:0.00;" json:"extract_price"`            // 提现金额
	...
	Status       int8      `gorm:"column:status;type:tinyint;comment:-1 未通过 0 审核中 1 已提现;default:0;" json:"status"`                              // -1 未通过 0 审核中 1 已提现
