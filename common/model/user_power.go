...
func (p *EbSystemUserPower) FindUserLevelPower() (result []EbSystemUserPower, err error) {
	err = global.DB.Debug().Table("eb_system_user_power").Find(&result).Error
	if err != nil {
		return nil, err
	}
	return result, nil
