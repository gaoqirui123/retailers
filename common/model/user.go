...
type User struct {
	...
	NowMoney       uint32  `gorm:"column:now_money;type:decimal(8, 2) UNSIGNED;comment:用户余额;not null;default:0.00;" json:"now_money"`    // 用户余额
	...
	Integral       uint32  `gorm:"column:integral;type:decimal(8, 2) UNSIGNED;comment:用户剩余积分;not null;default:0.00;" json:"integral"`    // 用户剩余积分
	...
	IsPromoter     uint8   `gorm:"column:is_promoter;type:tinyint UNSIGNED;comment:是否为推广员/1是2否;not null;default:1;" json:"is_promoter"`  // 是否为推广员/1是2否
