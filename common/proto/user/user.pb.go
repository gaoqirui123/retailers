...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0x48, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	...
	0x04, 0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x5f, 0x0a, 0x13, 0x55, 0x73, 0x65,
	...
	0x28, 0x04, 0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x40, 0x0a, 0x0e, 0x53, 0x65,
	...
	0x52, 0x07, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xc3, 0x01, 0x0a, 0x04, 0x55, 0x73,
	...
	0x53, 0x65, 0x6e, 0x64, 0x53, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
...
var file_user_proto_goTypes = []any{
	...
	(*SendSmsRequest)(nil),       // 4: user.SendSmsRequest
	(*SendSmsResponse)(nil),      // 5: user.SendSmsResponse
}
var file_user_proto_depIdxs = []int32{
	...
	4, // 2: user.User.SendSms:input_type -> user.SendSmsRequest
	1, // 3: user.User.UserLogin:output_type -> user.UserLoginResponse
	3, // 4: user.User.UserRegister:output_type -> user.UserRegisterResponse
	5, // 5: user.User.SendSms:output_type -> user.SendSmsResponse
